...
import { BiBed, BiBath, BiArch, BiArea } from 'react-icons/bi';
            ...
            <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8'>
              ...
              <div className='flex flex-col items-start gap-x-16 lg:flex-row '>
                ...
                <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-8 py-8'>
                  ...
                  <form className='flex flex-col gap-y-4 md:flex-auto'>
                    ...
                    placeholder='Message*'
                    defaultValue='Hello i am intersted in [Morden apartment]'></textarea>
